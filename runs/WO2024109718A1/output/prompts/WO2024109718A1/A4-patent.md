...
**Input:** `input/WO2024109718A1-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/WO2024109718A1-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `WO2024109718A1`

TITLE (zh): `环磺酮的制备方法和中间体`
TITLE (en): `Method for preparing tembotrione, and intermediates`
