...
This pass replaces OCR. US20040236146A1 does carry a text layer, 11,953 characters across 4 pages, so the prose can be read without this pass. It runs anyway because the information that matters most is
