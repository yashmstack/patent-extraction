...
**Input:** `input/CN106008290A-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/CN106008290A-biblio.json`, which was scraped from Google Patents, and are
...
TITLE (zh): `一种环磺酮的制备方法`
TITLE (en): `A method for preparing tembotrione`
